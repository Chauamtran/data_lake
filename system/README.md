This repo aims at creating a 3 node hadoop cluster having 1 master and 2 worker nodes using docker.io containers. 
...
**Update: Added pyspark support by installing python 3.6.8** ... Change to your default python version in spark Dockerfile
...
2. Once all images are built, start cluster by **./cluster.sh start version(1.0.0)**
